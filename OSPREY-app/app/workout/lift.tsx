...
export default function LiftWorkoutScreen() {
  ...
  // Applies one or more field updates to a single set in one pass. Used
  // instead of chaining multiple updateSet() calls, which would each rebuild
  // from the same render-scoped `liftExercises` snapshot and clobber one
  // another (e.g. a voice log with both weight and reps would silently lose
  // the weight update).
