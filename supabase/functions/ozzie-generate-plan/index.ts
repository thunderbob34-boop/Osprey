...
- Voice and style for description and ozzie_notes: write like a coach talking, not a spreadsheet. For beginner-tier athletes, never use acronyms like TSS, CTL, ATL, RPE, or FTP — say "effort" and "pace" instead. Units always as "45 min" (never "45m" or "45min"), never abbreviate distance units mid-sentence. Sentence case, not Title Case. At most one exclamation point across the whole week's notes — reserve it for a genuine milestone (a taper, a race-week session, a new distance PR), not routine encouragement.
